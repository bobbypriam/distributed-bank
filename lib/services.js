        ...
        .then(userData => {
          ...
          if (userData.ip_domisili == 'https://priambodo.sisdis.ui.ac.id/bank/wsdl') {
            ...
            soap.createClient(userData.ip_domisili, (err, client) => {
              ...
              console.log(`Calling getTotalSaldo on ${userData.ip_domisili}`);
              client.getTotalSaldo({ user_id: userData.user_id }, (err, response) => {
                ...
                console.log(`Calculating balance on ${userData.ip_domisili}`);
                ...
                console.log(`Done. balance on ${userData.ip_domisili}: ${balance}`);
